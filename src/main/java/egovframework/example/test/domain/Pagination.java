...
public class Pagination {
	...
	private int listSize = 10; // 초기값으로 목록개수를 10으로 셋팅 한 페이지당 보여질 게시글의 개수
	...
	public void pageInfo(int page, int range, int listCnt) {
		...
		// 게시판 시작번호
		this.startList = (page - 1) * listSize;    // 페이지에서 첫번째 게시물을 뭐로할거냐로 설정하기 db에서 몇번째 행의 데이터를 가져올건지 그 몇번째 행이 이 값
